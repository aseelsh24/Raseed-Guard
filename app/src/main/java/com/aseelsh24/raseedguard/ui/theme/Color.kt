package com.aseelsh24.raseedguard.ui.theme

import androidx.compose.ui.graphics.Color

// Light Theme Colors
val md_theme_light_primary = Color(0xFF006C7C) // Teal-ish Blue
...
val md_theme_light_background = Color(0xFFF8FDFF) // Off-white
val md_theme_light_onBackground = Color(0xFF001F24)
val md_theme_light_surface = Color(0xFFF8FDFF) // Near-white
val md_theme_light_onSurface = Color(0xFF001F24)
val md_theme_light_surfaceVariant = Color(0xFFDBE4E6) // Light gray
val md_theme_light_onSurfaceVariant = Color(0xFF3F484A)
val md_theme_light_outline = Color(0xFF6F797A) // Subtle gray

// Dark Theme Colors
val md_theme_dark_primary = Color(0xFF4FD8EB) // Slightly desaturated Teal
val md_theme_dark_onPrimary = Color(0xFF00363D)
val md_theme_dark_primaryContainer = Color(0xFF004F5B)
...
val md_theme_dark_background = Color(0xFF001F24) // Near-black
val md_theme_dark_onBackground = Color(0xFFA6EEFF)
val md_theme_dark_surface = Color(0xFF001F24) // Near-black
val md_theme_dark_onSurface = Color(0xFFA6EEFF)
val md_theme_dark_surfaceVariant = Color(0xFF3F484A) // Dark gray
